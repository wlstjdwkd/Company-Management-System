 ...
 * 거래유형별현황 엑셀
 */
public class PGPS0030ExcelVO implements IExcelVO {

	private static Logger logger = LoggerFactory.getLogger(PGPS0030ExcelVO.class);

    private String fileNmae = "";
    private int colIndex = 0;
    
    public PGPS0030ExcelVO() {

    }

    public PGPS0030ExcelVO(String fileName) {
        super();
