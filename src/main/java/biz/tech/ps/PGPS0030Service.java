 ...
 */
@Service("PGPS0030")
public class PGPS0030Service extends EgovAbstractServiceImpl {
	
	private static final Logger logger = LoggerFactory.getLogger(PGPS0030Service.class);
	...
	public ModelAndView index(Map rqstMap) throws Exception {
		ModelAndView mv = new ModelAndView("/admin/ps/BD_UIPSA0030");
	...
	public ModelAndView selectStaticsSellAm(Map rqstMap) throws Exception {
		ModelAndView mv = new ModelAndView("/admin/ps/BD_UIPSA0031");
	...
	public List<Map> selectStaticsData(Map rqstMap) throws Exception {
		...
		return pgps0030Dao.selectStaticsDataList(param);
	}
	...
	public List<Map> selectStaticsList(Map rqstMap) throws Exception {
		...
		// 제조/비제조 소계
		BigDecimal sumB2BCo = new BigDecimal(0);
		BigDecimal sumB2CCo = new BigDecimal(0);
		BigDecimal sumB2GCo = new BigDecimal(0);
		BigDecimal sumCo = new BigDecimal(0);
		BigDecimal sumB2BXPAm = new BigDecimal(0);
		BigDecimal sumB2CXPAm = new BigDecimal(0);
		BigDecimal sumB2GXPAm = new BigDecimal(0);
		BigDecimal sumXPAm = new BigDecimal(0);
		BigDecimal sumB2BDMAm = new BigDecimal(0);
		BigDecimal sumB2CDMAm = new BigDecimal(0);
		BigDecimal sumB2GDMAm = new BigDecimal(0);
		BigDecimal sumDMAm = new BigDecimal(0);
		
		// 전산업
		BigDecimal totalB2BCo = new BigDecimal(0);
		BigDecimal totalB2CCo = new BigDecimal(0);
		BigDecimal totalB2GCo = new BigDecimal(0);
		BigDecimal totalCo = new BigDecimal(0);
		BigDecimal totalB2BXPAm = new BigDecimal(0);
		BigDecimal totalB2CXPAm = new BigDecimal(0);
		BigDecimal totalB2GXPAm = new BigDecimal(0);
		BigDecimal totalXPAm = new BigDecimal(0);
		BigDecimal totalB2BDMAm = new BigDecimal(0);
		BigDecimal totalB2CDMAm = new BigDecimal(0);
		BigDecimal totalB2GDMAm = new BigDecimal(0);
		...
		for (int i=0; i<resultList.size(); i++) {
			...
			if (cndInduty) {
				...
				if (!stdIndutyFt.equals(indutyFt) || cndArea && !stdAreaFt.equals(areaFt)) {
					...
					sumMap.put("gbnIs", "S");
					sumMap.put("b2bCo", sumB2BCo);
					sumMap.put("b2cCo", sumB2CCo);
					sumMap.put("b2gCo", sumB2GCo);
					sumMap.put("sumCo", sumCo);
					sumMap.put("b2bXportAm", sumB2BXPAm);
					sumMap.put("b2cXportAm", sumB2CXPAm);
					sumMap.put("b2gXportAm", sumB2GXPAm);
					sumMap.put("sumXportAm", sumXPAm);
					sumMap.put("b2bDomeAm", sumB2BDMAm);
					sumMap.put("b2cDomeAm", sumB2CDMAm);
					sumMap.put("b2gDomeAm", sumB2GDMAm);
					...
					sumB2BCo = new BigDecimal(0);
					sumB2CCo = new BigDecimal(0);
					sumB2GCo = new BigDecimal(0);
					sumCo = new BigDecimal(0);
					sumB2BXPAm = new BigDecimal(0);
					sumB2CXPAm = new BigDecimal(0);
					sumB2GXPAm = new BigDecimal(0);
					sumXPAm = new BigDecimal(0);
					sumB2BDMAm = new BigDecimal(0);
					sumB2CDMAm = new BigDecimal(0);
					sumB2GDMAm = new BigDecimal(0);
				...
				if (cndArea && !stdAreaFt.equals(areaFt)) {
					...
					sumMap.put("gbnAs", prevInfo.get("gbnAs"));
					sumMap.put("gbnIs", "S");
					sumMap.put("b2bCo", totalB2BCo);
					sumMap.put("b2cCo", totalB2CCo);
					sumMap.put("b2gCo", totalB2GCo);
					sumMap.put("sumCo", totalCo);
					sumMap.put("b2bXportAm", totalB2BXPAm);
					sumMap.put("b2cXportAm", totalB2CXPAm);
					sumMap.put("b2gXportAm", totalB2GXPAm);
					sumMap.put("sumXportAm", totalXPAm);
					sumMap.put("b2bDomeAm", totalB2BDMAm);
					sumMap.put("b2cDomeAm", totalB2CDMAm);
					sumMap.put("b2gDomeAm", totalB2GDMAm);
					...
					totalB2BCo = new BigDecimal(0);
					totalB2CCo = new BigDecimal(0);
					totalB2GCo = new BigDecimal(0);
					totalCo = new BigDecimal(0);
					totalB2BXPAm = new BigDecimal(0);
					totalB2CXPAm = new BigDecimal(0);
					totalB2GXPAm = new BigDecimal(0);
					totalXPAm = new BigDecimal(0);
					totalB2BDMAm = new BigDecimal(0);
					totalB2CDMAm = new BigDecimal(0);
					totalB2GDMAm = new BigDecimal(0);
					totalDMAm = new BigDecimal(0);
				}
				
				// 제조/비제조 합계
				sumB2BCo = sumB2BCo.add((BigDecimal) resultInfo.get("b2bCo"));
				sumB2CCo = sumB2CCo.add((BigDecimal) resultInfo.get("b2cCo"));
				sumB2GCo = sumB2GCo.add((BigDecimal) resultInfo.get("b2gCo"));
				sumCo = sumCo.add((BigDecimal) resultInfo.get("sumCo"));
				sumB2BXPAm = sumB2BXPAm.add((BigDecimal) resultInfo.get("b2bXportAm"));
				sumB2CXPAm = sumB2CXPAm.add((BigDecimal) resultInfo.get("b2cXportAm"));
				sumB2GXPAm = sumB2GXPAm.add((BigDecimal) resultInfo.get("b2gXportAm"));
				sumXPAm = sumXPAm.add((BigDecimal) resultInfo.get("sumXportAm"));
				sumB2BDMAm = sumB2BDMAm.add((BigDecimal) resultInfo.get("b2bDomeAm"));
				sumB2CDMAm = sumB2CDMAm.add((BigDecimal) resultInfo.get("b2cDomeAm"));
				sumB2GDMAm = sumB2GDMAm.add((BigDecimal) resultInfo.get("b2gDomeAm"));
				sumDMAm = sumDMAm.add((BigDecimal) resultInfo.get("sumDomeAm"));
				
				// 지역별 전산업 합계
				totalB2BCo = totalB2BCo.add((BigDecimal) resultInfo.get("b2bCo"));
				totalB2CCo = totalB2CCo.add((BigDecimal) resultInfo.get("b2cCo"));
				totalB2GCo = totalB2GCo.add((BigDecimal) resultInfo.get("b2gCo"));
				totalCo = totalCo.add((BigDecimal) resultInfo.get("sumCo"));
				totalB2BXPAm = totalB2BXPAm.add((BigDecimal) resultInfo.get("b2bXportAm"));
				totalB2CXPAm = totalB2CXPAm.add((BigDecimal) resultInfo.get("b2cXportAm"));
				totalB2GXPAm = totalB2GXPAm.add((BigDecimal) resultInfo.get("b2gXportAm"));
				totalXPAm = totalXPAm.add((BigDecimal) resultInfo.get("sumXportAm"));
				totalB2BDMAm = totalB2BDMAm.add((BigDecimal) resultInfo.get("b2bDomeAm"));
				totalB2CDMAm = totalB2CDMAm.add((BigDecimal) resultInfo.get("b2cDomeAm"));
				totalB2GDMAm = totalB2GDMAm.add((BigDecimal) resultInfo.get("b2gDomeAm"));
	...
	public ModelAndView excelStatics(Map rqstMap) throws Exception {
		...
		if (MapUtils.getString(rqstMap, "ad_type", "1").equals("1")) {
			...
			items.add("b2bDomeAm");
			items.add("b2bXportAm");
			items.add("b2cDomeAm");
			items.add("b2cXportAm");
			items.add("b2gDomeAm");
			items.add("b2gXportAm");
			items.add("sumDomeAm");
		...
		if (MapUtils.getString(rqstMap, "ad_type", "1").equals("1")) {
			excel = new ExcelVO("거래유형별현황_기업현황_"+DateFormatUtil.getTodayFull());
		} else {
			String[] arrySubHeaders = new String[] {};
			arrySubHeaders = subHeaders.toArray(arrySubHeaders);
			mv.addObject("_subHeaders", arrySubHeaders);
			
			excel = new PGPS0030ExcelVO("거래유형별현황_매출형태_"+DateFormatUtil.getTodayFull());
		}
	...
	public ModelAndView getAllChart(Map rqstMap) throws Exception {
		...
		if(MapUtils.getInteger(rqstMap, "ad_type") == 1) {
			mv.setViewName("/admin/ps/PD_UIPSA0030_1");
		}
		// 매출형태챠트
		else if(MapUtils.getInteger(rqstMap, "ad_type") == 2) {
			mv.setViewName("/admin/ps/PD_UIPSA0031_1");
		}
	...
	public ModelAndView getPrintOut(Map rqstMap) throws Exception {
		...
		// 기업현황출력
		if(MapUtils.getInteger(rqstMap, "ad_type") == 1) {
			mv.setViewName("/admin/ps/PD_UIPSA0030_2");
		}
		// 매출형태출력
		else if(MapUtils.getInteger(rqstMap, "ad_type") == 2) {
			mv.setViewName("/admin/ps/PD_UIPSA0030_2");
