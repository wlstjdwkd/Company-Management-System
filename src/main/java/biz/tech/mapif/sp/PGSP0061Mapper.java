...
@Mapper("PGSP0061Mapper")
public interface PGSP0061Mapper {
	...
	public void insertGalleryBoard(Map<?, ?> req) throws Exception;


	public int selectGalleryBoardCount(Map<?, ?> param) throws Exception;


	public List<Map> selectGalleryBoardInfo(Map<?, ?> param) throws Exception;


	public String getMaxBizSeq();


	public Map findMenuInfo(HashMap param);


	public void deleteMenu(HashMap param);


	public void updateGalleryBoard(Map<?, ?> req);
