 ...
 */
@Service("PGIC0021")
public class PGIC0021Service extends EgovAbstractServiceImpl {

	private static final Logger logger = LoggerFactory.getLogger(PGIC0021Service.class);
	...
	public ModelAndView index(Map<?, ?> rqstMap) throws Exception {
		...
		return new ModelAndView("/www/ic/BD_UIICU0021");
	}
