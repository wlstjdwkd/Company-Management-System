...
public class QustnrRespondInfoDao extends EgovAbstractMapper {
	...
	public List selectQustnrTmplatManage(Map map) throws Exception{
		return (List)selectList("QustnrRespondInfo.selectQustnrTmplatManages", map);
	}
	...
	public List selectQustnrRespondInfoManageStatistics1(Map map) throws Exception{
		return (List)selectList("QustnrRespondInfo.selectQustnrRespondInfoManageStatistics1", map);
	}
    /**
	 * 주관식 통계를 조회 조회한다. 
	 * @param map - 조회할 정보가 담긴 map
	...
	public List selectQustnrRespondInfoManageStatistics2(Map map) throws Exception{
		return (List)selectList("QustnrRespondInfo.selectQustnrRespondInfoManageStatistics2", map);
	}
	...
	public List selectQustnrRespondInfoManageComtnqestnrinfo(Map map) throws Exception{
		return (List)selectList("QustnrRespondInfo.selectQustnrRespondInfoManageComtnqestnrinfo", map);
	}
    /**
	 * 문항정보를 조회한다. 
	 * @param map - 조회할 정보가 담긴 map
	...
	public List selectQustnrRespondInfoManageComtnqustnrqesitm(Map map) throws Exception{
		return (List)selectList("QustnrRespondInfo.selectQustnrRespondInfoManageComtnqustnrqesitm", map);
	}
    /**
	 * 항목정보를 조회한다. 
	 * @param map - 조회할 정보가 담긴 map
	...
	public List selectQustnrRespondInfoManageComtnqustnriem(Map map) throws Exception{
		return (List)selectList("QustnrRespondInfo.selectQustnrRespondInfoManageComtnqustnriem", map);
	}
	...
	public List selectQustnrRespondInfoManageList(ComDefaultVO searchVO) throws Exception{
		return (List)selectList("QustnrRespondInfo.selectQustnrRespondInfoManage", searchVO);
	}
	...
	public List selectQustnrRespondInfoList(ComDefaultVO searchVO) throws Exception{
		return (List)selectList("QustnrRespondInfo.selectQustnrRespondInfo", searchVO);
	}
	...
	public List selectQustnrRespondInfoDetail(QustnrRespondInfoVO qustnrRespondInfoVO) throws Exception{
		return (List)selectList("QustnrRespondInfo.selectQustnrRespondInfoDetail", qustnrRespondInfoVO);
	}
	...
	/**
	 * 중복응답 체크
	 * @param param 응답자 이메일주소, 설문ID, 설문템플릿ID
	 * @return
	 * @throws Exception
	 */
	public int selectCheckDuplQustnrRespond(Map<?, ?> param) throws Exception{
		return (Integer)selectOne("QustnrRespondInfo.selectCheckDuplQustnrRespond", param);
	}
}
