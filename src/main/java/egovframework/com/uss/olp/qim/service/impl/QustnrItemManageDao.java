...
public class QustnrItemManageDao extends EgovAbstractMapper {
	...
	public int selectQustnrItemSNCnt(QustnrItemManageVO qustnrItemManageVO) throws Exception{
		return (Integer)selectOne("QustnrItemManage.selectQustnrItemSNCnt", qustnrItemManageVO);
	}
	...
	public List selectQustnrTmplatManageList(QustnrItemManageVO qustnrItemManageVO) throws Exception{
		return (List)selectList("QustnrItemManage.selectQustnrTmplatManage", qustnrItemManageVO);
	}
	...
	public List selectQustnrItemManageList(ComDefaultVO searchVO) throws Exception{
		return (List)selectList("QustnrItemManage.selectQustnrItemManage", searchVO);
	}
	...
	public List selectQustnrItemManageDetail(QustnrItemManageVO qustnrItemManageVO) throws Exception{
		return (List)selectList("QustnrItemManage.selectQustnrItemManageDetail", qustnrItemManageVO);
	}
