...
public class QustnrQestnManageDao extends EgovAbstractMapper {
	...
	/**
	 * 설문문항 순번 중복 조회
	 * @param qustnrQestnManageVO - 설문문항 순번 담김 VO
	 * @return
	 * @throws Exception
	 */
	public int selectQustnrQestnSNCnt(QustnrQestnManageVO qustnrQestnManageVO) throws Exception{
		return (Integer)selectOne("QustnrQestnManage.selectQustnrQestnSNCnt", qustnrQestnManageVO);
	}
	...
	public List selectQustnrManageStatistics2(Map map) throws Exception{
		return (List)selectList("QustnrQestnManage.selectQustnrManageStatistics2", map);
	}
	...
	public List selectQustnrManageStatistics(Map map) throws Exception{
		return (List)selectList("QustnrQestnManage.selectQustnrManageStatistics", map);
	}
	...
	public List selectQustnrQestnManageList(ComDefaultVO searchVO) throws Exception{
		return (List)selectList("QustnrQestnManage.selectQustnrQestnManage", searchVO);
	}
	...
	public List selectQustnrQestnManageDetail(QustnrQestnManageVO qustnrQestnManageVO) throws Exception{
		return (List)selectList("QustnrQestnManage.selectQustnrQestnManageDetail", qustnrQestnManageVO);
	}
