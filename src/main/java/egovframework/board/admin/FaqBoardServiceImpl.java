...
public class FaqBoardServiceImpl extends EgovAbstractServiceImpl implements BoardService {
    ...
    public List<BoardVO> boardList(BoardVO boardVO, String listSkin) {
        // 설정과 관계없이 제목은 다 보여줌
        boardVO.setCutTitleNum(null);

        List<BoardVO> dataList = boardDao.boardList(boardVO, listSkin);
    ...
    public List<BoardVO> noticeList(BoardVO boardVO, String listSkin) {
        ...
        List<BoardVO> dataList = boardDao.noticeList(boardVO, listSkin);
