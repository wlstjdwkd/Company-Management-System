...
<script type="text/javascript">
	...
	$().ready(function(){
		...
		$("#btn_submit").click(function(){
			...
			$("#displayColumns2 > option").prop("selected", "selected");
		...
		$("#btn_reset").click(function(){
			changeFlag=false;
			document.viewArrangeForm.reset();
		});
	});
...
<form id="viewArrangeForm" name="viewArrangeForm">
<input type="hidden" name="bbsCd" value="${param.bbsCd}" />
<input type="hidden" name="listViewGubun" value="<%= BoardConfConstant.GUBUN_DISPLAY_COLUMN_VIEW %>" />
<ap:include page="param/defaultParam.jsp" />

	<!-- 게시판 상세 배치 시작 -->
	<fieldset>
		<legend>상세 배치 설정</legend>
		<table class="table_basic" border="0" cellspacing="0" cellpadding="0" summary="상세 배치" >
			...
			<tbody>
				...
				<tr>
					<td>
						<select id="allColumns2" name="allColumns" size="15" style="width:200px;height:250px;" multiple>
					...
					<td>
						<select id="displayColumns2" name="displayColumns" size="15" style="width:200px;height:250px;" multiple>
