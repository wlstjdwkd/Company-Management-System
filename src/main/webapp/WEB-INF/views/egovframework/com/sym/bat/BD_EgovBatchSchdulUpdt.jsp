	...
	$("#batchSchdul").validate({  
		submitHandler: function(form) {
			...
			jsMsgBox(null, 'confirm','<spring:message code="confirm.common.save" />', function(){
				...
				$("#df_method_nm").val("updateBatchSchdul");
				form.submit();
			});
		}
	});	
...
<body>
    <div id="wrap">
        <div class="wrap_inn">
            <div class="contents">
                <!--// 타이틀 영역 -->
                <h2 class="menu_title_line">배치스케줄수정</h2>
                <!-- 타이틀 영역 //-->
                <div class="block">
                    <h3 class="mgt30">
                    ...
                    <table cellpadding="0" cellspacing="0" class="table_basic mgt10" summary="배치ID, 배치작업명, 스케줄 입력">
                        <caption>배치스케줄수정폼</caption>
                        <colgroup>
                        <col width="15%" />
                        <col width="*" />
                        </colgroup>
                        <tr>
                            <th scope="row" class="point"><label for="batchSchdulId">배치스케줄ID</label></th>
                            <td><form:input path="batchSchdulId" cssStyle="width:762px" maxlength="20" readonly="true" title="배치스케줄ID" cssClass="inp_blue"/>
        							<form:errors path="batchSchdulId" cssClass="hiddden_txt" element="div" />
        					</td>
                        </tr>
                        <tr>
