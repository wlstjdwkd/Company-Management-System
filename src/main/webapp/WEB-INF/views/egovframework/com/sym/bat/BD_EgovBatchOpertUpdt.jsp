...
$(document).ready(function(){
	...
	$("#batchOpert").validate({  
		...
		submitHandler: function(form) {
			jsMsgBox(null, 'confirm','<spring:message code="confirm.common.save" />', function(){$("#df_method_nm").val("updateBatchOpert");form.submit();});
		}
	});
});
...
<body>
   <div id="wrap">
        <div class="wrap_inn">
            <div class="contents">
                <!--// 타이틀 영역 -->
                <h2 class="menu_title_line">배치작업수정</h2>
                <!-- 타이틀 영역 //-->
                <div class="block">
                    <h3 class="mgt30">
                    ...
                    <table cellpadding="0" cellspacing="0" class="table_basic mgt10" summary="배치작업명, 배치프로그램, 파라미터 입력">
                        ...
                        <tr>
                            ...
                            <td>
                            	<form:input path="batchOpertNm" maxlength="60" cssStyle="width:762px" title="배치작업명입력" />
                        ...
                        <tr>
                            ...
                            <td>
                            	<form:input path="batchProgrm" maxlength="255" cssStyle="width:762px" title="배치프로그램입력" />
                            	<form:errors path="batchProgrm" cssClass="hiddden_txt" element="div" /> </td>
                        </tr>
                        <tr>
                            <th scope="row"><label for="paramtr">파라미터</label></th>
                            <td>
                            	<form:input path="paramtr" maxlength="250" cssStyle="width:762px" title="파라미터입력" />
