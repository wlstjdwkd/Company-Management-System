	...
	$("#qustnrManageVO").validate({
		...
		submitHandler: function(form) {
			...
			jsMsgBox(null, 'confirm','<spring:message code="confirm.common.save" />', function(){
				$("#cmd").val("save");
				$("#df_method_nm").val("updateEgovQustnrManage");
				form.submit();
			});
		}
	});	
        ...
        <div class="wrap_inn">
            <div class="contents">
                ...
                <div>
                    ...
                    <table cellpadding="0" cellspacing="0" class="table_basic" summary="설문정보수정">
                        <caption>
                        설문정보수정
                        </caption>
                        <colgroup>
                            ...
                            <tr>
                                ...
                                <td><ul class="def">
									<c:forEach items="${listQustnrTmplat}" var="resultQustnrTmplat" varStatus="status">
                                        <li>
                                            <input type="radio" name="qestnrTmplatIds" id="qestnrTmplatIds_${status.count }" value="${resultQustnrTmplat.qestnrTmplatId}" <c:if test="${resultList[0].qestnrTmplatId == resultQustnrTmplat.qestnrTmplatId}">checked </c:if>disabled />
                                            <label for="qestnrTmplatIds_${status.count }">${resultQustnrTmplat.qestnrTmplatTy}</label>
                                        </li>
									</c:forEach>
                                    </ul></td>
                            </tr>
