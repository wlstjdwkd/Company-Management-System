	...
	$("#qustnrTmplatManageVO").validate({  
		...
		submitHandler: function(form) {
			...
			jsMsgBox(null, 'confirm','<spring:message code="confirm.common.save" />', 
					function(){$("#df_method_nm").val("updateEgovQustnrTmplatManage");form.submit();});
		}
	});
...
<body>
   <div id="wrap">
        <div class="wrap_inn">
            <div class="contents">
                <!--// 타이틀 영역 -->
                <h2 class="menu_title">설문템플릿수정</h2>
                <!-- 타이틀 영역 //-->
				...
				<input type="hidden" name="qestnrTmplatId" id="qestnrTmplatId" value="${resultList[0].qestnrTmplatId} ">
                    ...
                    <table cellpadding="0" cellspacing="0" class="table_basic" summary="설문템플릿등록">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>
                                	<input type="text" id="qestnrTmplatTy" name="qestnrTmplatTy" style="width:90%;" maxlength="100" title="템플릿명 입력" value="<c:out value="${resultList[0].qestnrTmplatTy}" />" />
                            ...
                            <tr>
                                ...
                                <td>
                                	<input type="text" id="qestnrTmplatCours" name="qestnrTmplatCours" style="width:88%;" maxlength="100" title="템플릿경로 입력" value="<c:out value="${resultList[0].qestnrTmplatCours}" />" />.jsp
                            ...
                            <tr>
                                ...
                                <td>
                                	<textarea name="qestnrTmplatCn" id="qestnrTmplatCn" rows="8" style="width:90%;" title="템플릿설명 입력">${resultList[0].qestnrTmplatCn}</textarea>
