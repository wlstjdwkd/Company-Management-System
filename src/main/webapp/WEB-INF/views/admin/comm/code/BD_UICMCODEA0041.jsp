	...
	$(document).ready(
			...
			function() {
				...
				$("#btn_code_list").click(function() {
					document.dataForm.df_curr_page.value = 1;
				...
				// 취소
				$("#btn_code_reset").click(function() {
					$("#df_method_nm").val("codeInsertForm");
					document.dataForm.submit();
				});

				// 확인
				$("#btn_code_insert").click(function() {
	...
	<form name="dataForm" id="dataForm" action="<c:url value='${svcUrl}' />" method="post">
		...
		<div id="wrap">
			<div class="wrap_inn">
				<div class="contents">
					<!--// 타이틀 영역 -->
					<h2 class="menu_title_line">코드등록</h2>
					<!-- 타이틀 영역 //-->
					<div class="block">
						<h3 class="mgt30">
						...
						<table cellpadding="0" cellspacing="0" class="table_basic mgt10" summary="코드등록">
							...
							<tr>
								<th scope="row" class="point"><label for="codeGroupNm"> 코드명</label></th>
								<td><input name="codeGroupNm" title="입력" id="codeGroupNm" type="text"
					...
					<div class="btn_page_last">
						<a class="btn_page_admin" href="#none" id="btn_code_list"><span>목록</span></a> <a
							class="btn_page_admin" href="#none" id="btn_code_reset"><span>취소</span></a> <a
							class="btn_page_admin" href="#none" id="btn_code_insert"><span>확인</span></a>
					</div>
					<!-- // 리스트영역-->
					<div class="block">
						<h3>하위코드</h3>
						...
						<!-- 리스트// -->
						<div class="btn_page_last">
							<a class="btn_page_admin" href="#none" id="btn_code_delete"><span>삭제</span></a>
