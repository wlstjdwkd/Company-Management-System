                    ...
                    <div class="block">
                        ...
                        <table cellpadding="0" cellspacing="0" class="table_basic" summary="" >
                            ...
                            <tr>
                                ...
                                <td><input name="ad_user_nm" type="text" id="ad_user_nm" value="${dataVO.userNm }" class="text" style="width:395px;"  placeholder="홍길동" /></td>
                            </tr>
                            <tr>
                                <th scope="row" class="point"><label for="ad_dept">소속부서</label></th>
                                <td><input name="ad_dept" type="text" id="ad_dept" value="${dataVO.deptNm }" class="text" style="width:395px;" placeholder="소속부서를 입력해 주세요." /></td>
                            </tr>
                            <tr>
                                <th scope="row"><label for="ad_ofcps">직위</label></th>
                                <td><input name="ad_ofcps" type="text" id="ad_ofcps" value="${dataVO.ofcps }" class="text" style="width:395px;" placeholder="직위를 입력해 주세요." /></td>
                            </tr>
                            <tr>
                                <th scope="row" class="point"><label for="ad_tel"> 전화번호</label></th>
                                <td><select name="ad_tel_first" id="ad_tel_first" style="width:101px; ">
                                    ...
                                    ~
                                    <input name="ad_tel_middle" type="text" id="ad_tel_middle" value="${dataMap.TELNO2 }" class="text"style="width:127px;" title="전화가운데번호" />
                                    ~
                                    <input name="ad_tel_last" type="text" id="ad_tel_last" value="${dataMap.TELNO3 }" class="text"style="width:127px;" title="전화마지막번호" /></td>
                            </tr>
                            <tr>
