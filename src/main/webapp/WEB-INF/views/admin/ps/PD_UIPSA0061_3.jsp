	...
	<div class="pop_q_con">
	    ...
	    <div class="search_top">
	        ...
	        <div class="remark_20 mgb30">
                <ul>
                    <li class="remark1">매출액-기업</li>
                    <li class="remark2">매출액-규모기준</li>
                    <li class="remark3">상시근로자수-기업</li>
                    <li class="remark4">상시근로자수-규모기준</li>
                    <li class="remark5">수출액-기업</li>
                    <li class="remark6">수출액-규모기준</li>
                    <li class="remark7">기업수-기업</li>
                    <li class="remark8">기업수-규모기준</li>
                </ul>
            </div>
