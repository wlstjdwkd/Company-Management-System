...
<script type="text/javascript">
	...
	function printOut() {
		...
		$.colorbox({
	        title : "가젤형기업분석 주요지표현황 출력",
	        href : "PGPS0050.do?df_method_nm=getPrintOut3&searchEntprsGrp="+searchEntprsGrp+"&searchStdyy="
...
<div id="wrap">
    <div class="wrap_inn">
        <div class="contents">
			...
			<!-- 탭구분 구분 -->
			<input type="hidden" id="ad_type" name="ad_type" value="4" />
			
            <!--// tab -->
            <div class="tabwrap">
                <div class="tab">
                    <ul id="gnb">
                        <li><a href="#none" onclick="changeTab(1);">업종별분포추이</a></li><li onclick="changeTab(2);"><a href="#none">기업규모별현황</a></li><li onclick="changeTab(3);"><a href="#none">업력별분포추이</a></li><li class="on" onclick="changeTab(4);"><a href="#none">주요지표현황</a></li>
                    </ul>
                </div>
                           ...
                           <caption>
                            ...
                            <thead>
                                <tr>
                                    ...
                                    <th scope="col">평균수출액(백만불)</th>
                                    <th scope="col">평균근로자수(명)</th>
                                    <th scope="col">평균R&D투자</th>
                                    <th scope="col">평균R&D투자비율(%)</th>
                                </tr>
                            </thead>
                            <tbody>
							<c:forEach items="${resultList }" var="resultInfo" varStatus="status">
								...
								<c:if test="${not empty param.searchInduty}">
									...
									<td class='tar'><fmt:formatNumber value="${resultInfo.entrprsCo }"/></td>
									<td class='tar'><fmt:formatNumber value="${resultInfo.avrgSelngAm }"/></td>
									<td class='tar'><fmt:formatNumber value="${resultInfo.avrgXportAmDollar }"/></td>
									<td class='tar'><fmt:formatNumber value="${resultInfo.avrgOrdtmLabrrCo }"/></td>
									<td class='tar'><fmt:formatNumber value="${resultInfo.avrgRsrchDevlopCt }"/></td>
									<td class='tar'><fmt:formatNumber value="${resultInfo.avrgRsrchDevlopRt }"/></td>
								</tr>				
                           	</c:forEach>
