    ...
    <div class="wrap_inn">
        <div class="contents">
            ...
            <div class="tabwrap">
                <div class="tab">
                    <ul id="gnb">
                        <li class="on" onclick="changeTab(1);"><a href="#none">기업현황</a></li><li onclick="changeTab(2);"><a href="#none">매출형태</a></li>
                    </ul>
                </div>
                           ...
                           <caption>
							...
							<c:forEach items="${resultList }" var="resultInfo" varStatus="status">                         		
								...
								<c:if test="${not empty param.searchInduty}">
									...
									<td class='tar'><fmt:formatNumber value="${resultInfo.b2bCo }"/></td>
									<td class='tar'><fmt:formatNumber value="${resultInfo.b2cCo }"/></td>
									<td class='tar'><fmt:formatNumber value="${resultInfo.b2gCo }"/></td>
									<td class='tar'><fmt:formatNumber value="${resultInfo.sumCo }"/></td>
								</tr>
                           	</c:forEach>
