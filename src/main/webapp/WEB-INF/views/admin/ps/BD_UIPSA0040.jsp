                           ...
                           <caption>
                            ...
                            <thead>
                                <tr>
                                    ...
                                    <th scope="col">외투기업</th>
                                    <th scope="col">비외투기업</th>
                                    <th scope="col">합계</th>
                                </tr>
                            </thead>
                            <tbody>
							<c:forEach items="${resultList }" var="resultInfo" varStatus="status">                         		
								...
								<c:if test="${not empty param.searchInduty}">
									...
									<td class='tar'><fmt:formatNumber value="${resultInfo.fieCo }"/></td>
									<td class='tar'><fmt:formatNumber value="${resultInfo.nfieCo }"/></td>
