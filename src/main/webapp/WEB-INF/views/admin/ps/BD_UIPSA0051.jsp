...
<script type="text/javascript">
	...
	function printOut() {
		...
		$.colorbox({
	        title : "가젤형기업분석 기업규모별현황 출력",
	        href : "PGPS0050.do?df_method_nm=getPrintOut1&searchEntprsGrp="+searchEntprsGrp+"&searchStdyy="
...
<div id="wrap">
    <div class="wrap_inn">
        <div class="contents">
            <!--// 타이틀 영역 -->
            <h2 class="menu_title">기업규모별현황</h2>
            <!-- 타이틀 영역 //-->
            ...
            <div class="tabwrap">
                <div class="tab">
                    <ul id="gnb">
                        <li><a href="#none" onclick="changeTab(1);">업종별분포추이</a></li><li class="on" onclick="changeTab(2);"><a href="#none">기업규모별현황</a></li><li onclick="changeTab(3);"><a href="#none">업력별분포추이</a></li><li onclick="changeTab(4);"><a href="#none">주요지표현황</a></li>
                    </ul>
                </div>
                <div class="tabcon" style="display: block;">
                       ...
                       <table cellspacing="0" border="0" summary="기업통계" class="list" id="tblStatics">
                           <caption>
                            ...
                            <col width="*" />
                            <c:forEach items="${scleNmList }" var="code" varStatus="status">
                            <col width="*" />
                            </c:forEach>
                            <col width="*" />
                            </colgroup>
							...
							<c:forEach items="${resultList }" var="resultInfo" varStatus="status">
								...
								<c:if test="${not empty param.searchInduty}">
									...
									<td class='tar'><fmt:formatNumber value="${resultInfo.sctn1 }"/></td>
									<td class='tar'><fmt:formatNumber value="${resultInfo.sctn2 }"/></td>
									<td class='tar'><fmt:formatNumber value="${resultInfo.sctn3 }"/></td>
									<td class='tar'><fmt:formatNumber value="${resultInfo.sctn4 }"/></td>
									<td class='tar'><fmt:formatNumber value="${resultInfo.sctn5 }"/></td>
									<td class='tar'><fmt:formatNumber value="${resultInfo.sctn6 }"/></td>
									<td class='tar'><fmt:formatNumber value="${resultInfo.sctn7 }"/></td>
									<td class='tar'><fmt:formatNumber value="${resultInfo.sctn8 }"/></td>
									<td class='tar'><fmt:formatNumber value="${resultInfo.sumSctn }"/></td>
								</tr>				
                           	</c:forEach>
