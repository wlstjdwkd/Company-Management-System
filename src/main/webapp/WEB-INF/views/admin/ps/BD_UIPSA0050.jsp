...
<script type="text/javascript">
	...
	function printOut() {
		...
		$.colorbox({
	        title : "가젤형기업분석 업종별분포추이 출력",
	        href : "PGPS0050.do?df_method_nm=getPrintOut0&searchEntprsGrp="+searchEntprsGrp+"&searchStdyySt="
    		+searchStdyySt+"&searchInduty="+searchInduty+"&searchIndutyVal="+searchIndutyVal+"&searchArea="
    		+searchArea+"&searchAreaVal="+searchAreaVal+"&ad_type="+ad_type+"&searchStdyyEd="+searchStdyyEd,
	        width : "80%",
	        height : "100%",
...
<div id="wrap">
    <div class="wrap_inn">
        <div class="contents">
            <!--// 타이틀 영역 -->
            <h2 class="menu_title">업종별분포추이</h2>
            <!-- 타이틀 영역 //-->
            ...
            <div class="tabwrap">
                <div class="tab">
                    <ul id="gnb">
                        <li class="on" onclick="changeTab(1);"><a href="#none">업종별분포추이</a></li><li onclick="changeTab(2);"><a href="#none">기업규모별현황</a></li><li onclick="changeTab(3);"><a href="#none">업력별분포추이</a></li><li onclick="changeTab(4);"><a href="#none">주요지표현황</a></li>
                    </ul>
                </div>
                           ...
                           <caption>
							...
							<c:forEach items="${resultList }" var="resultInfo" varStatus="status">                         		
								...
								<c:forEach var="outYr" begin="${stdyySt }" end="${stdyyEd }" varStatus="status">
									<c:set var="cname" value="y${status.count-1 }Co" />
