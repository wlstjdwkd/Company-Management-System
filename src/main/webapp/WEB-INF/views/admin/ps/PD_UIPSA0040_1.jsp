...
$(document).ready(function(){
	...
	if ( '${searchInduty}' != '') {
		...
		if (indutyListCnt * 2 < 100 ) {
			autoscaleMargin = 0.02;
			barWidth = 0.015;
		}		
		if (indutyListCnt * 2 < 60 ) {
			autoscaleMargin = 0.05;
			barWidth = 0.025;
		}
		if (indutyListCnt * 2 < 40 ) {
			autoscaleMargin = 0.05;
			barWidth = 0.04;			
		}
		if (indutyListCnt * 2 < 20 ) {
			autoscaleMargin = 0.1;
			barWidth = 0.09;
		}
		if (indutyListCnt * 2 < 10 ) {
			autoscaleMargin = 0.3;
			barWidth = 0.12;
		}
	...
	<div class="pop_q_con">
	    ...
	    <div class="search_top">
	        ...
	        <div class="remark_20 mgt20">
	    		<ul>
	    			<li class="remark1">외투기업</li>
	    			<li class="remark2">비외투기업</li>	    		
	    		</ul>
	    	</div>	    	        
	        <c:if test="${searchArea != '' && searchInduty != ''}">
