...
<script type="text/javascript">
	...
	function drawChart() {
		...
		$.colorbox({
	        title : "거래유형별현황 매출형태 차트",
	        href : "PGPS0030.do?df_method_nm=getAllChart&searchEntprsGrp="+searchEntprsGrp+"&searchStdyy="
	...
	function printOut() {
		...
		$.colorbox({
	        title : "거래유형별현황 매출형태 출력",
	        href : "PGPS0030.do?df_method_nm=getPrintOut&searchEntprsGrp="+searchEntprsGrp+"&searchStdyy="
    		+searchStdyy+"&searchInduty="+searchInduty+"&searchIndutyVal="+searchIndutyVal+"&searchArea="
    		+searchArea+"&searchAreaVal="+searchAreaVal+"&ad_type="+ad_type,
	        width : "80%",
	        height : "100%",
...
<div id="wrap">
    <div class="wrap_inn">
        <div class="contents">
            <!--// 타이틀 영역 -->
            <h2 class="menu_title">거래유형별현황</h2>
            <!-- 타이틀 영역 //-->
                           ...
                           <caption>
                            ...
                            <thead>
                                <tr>
                                    ...
                                    <th scope="col" colspan="2">B2B</th>
                                    <th scope="col" colspan="2">B2C</th>
                                    <th scope="col" colspan="2">B2G</th>
							...
							<c:forEach items="${resultList }" var="resultInfo" varStatus="status">                         		
								...
								<c:if test="${not empty param.searchInduty}">
									...
									<td class='tar'><fmt:formatNumber value="${resultInfo.b2bDomeAm }"/></td>
									<td class='tar'><fmt:formatNumber value="${resultInfo.b2bXportAm }"/></td>
									<td class='tar'><fmt:formatNumber value="${resultInfo.b2cDomeAm }"/></td>
									<td class='tar'><fmt:formatNumber value="${resultInfo.b2cXportAm }"/></td>
									<td class='tar'><fmt:formatNumber value="${resultInfo.b2gDomeAm }"/></td>
									<td class='tar'><fmt:formatNumber value="${resultInfo.b2gXportAm }"/></td>
