...
<script src="${contextPath}/gridDef/pm/RankGrid.js"></script>
...
<script type="text/javascript">
	...
	function return_opener(code, codeNm) {
		...
		opener.document.getElementById("poscd").value = code;
		opener.document.getElementById("posnm").value = codeNm;
	...
	function registerCallback() {		
		// 셀이 클릭 되었을 때 작동
		rankGridView.onCellClicked = function (grid, clickData) {
			if(clickData.cellType == "data") {
				var current = rankGridView.getCurrent();
				var arr = new Array();
				
				arr = rankDataProvider.getValues(current.dataRow);
		...
		<div class="pop_q_con">
			<form name="dataForm" id="dataForm" action="<c:url value='${svcUrl}' />" method="post">
				...
				<div class="block">
					<!--// 리스트 -->
					<div class="list_zone">
						<div id="rankgrid" style="height: 30em; background-color: white;"></div>
					</div>
					<!-- 리스트// -->
				</div>
				<!--content//-->
