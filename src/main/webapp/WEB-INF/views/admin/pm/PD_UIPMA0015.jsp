...
<script src="${contextPath}/gridDef/pm/DeptGrid.js"></script>
...
<script type="text/javascript">
	...
	function return_opener(code, codeNm) {
		...
		opener.document.getElementById("deptcd").value = code;
		opener.document.getElementById("deptnm").value = codeNm;
	...
	function registerCallback() {		
		// 셀이 클릭 되었을 때 작동
		deptGridView.onCellClicked = function (grid, clickData) {
			if(clickData.cellType == "data") {
				var current = deptGridView.getCurrent();
				var arr = new Array();
				
				arr = deptDataProvider.getValues(current.dataRow);
		...
		<div class="pop_q_con">
			<form name="dataForm" id="dataForm" action="<c:url value='${svcUrl}' />" method="post">
				...
				<div class="block">
					<!--// 리스트 -->
					<div class="list_zone">
						<div id="deptgrid" style="height: 30em; background-color: white;"></div>
					</div>
					<!-- 리스트// -->
				</div>
				<!--content//-->
