...
<script src="${contextPath}/gridDef/pm/WorkTypeGrid.js"></script>
...
<script type="text/javascript">
	...
	function return_opener(code, codeNm) {
		...
		opener.document.getElementById("wrktp").value = code;
		opener.document.getElementById("wrktpnm").value = codeNm;
	...
	function registerCallback() {		
		// 셀이 클릭 되었을 때 작동
		workTypeGridView.onCellClicked = function (grid, clickData) {
			if(clickData.cellType == "data") {
				var current = workTypeGridView.getCurrent();
				var arr = new Array();
				
				arr = workTypeDataProvider.getValues(current.dataRow);
	...
	<div id="self_dgs">
		<div class="pop_q_con">
			<form name="dataForm" id="dataForm" action="<c:url value='${svcUrl}' />" method="post">
				...
				<!--// 타이틀 영역 -->
				<h2 class="menu_title">근무 형태 선택</h2>
				<!-- 타이틀 영역 //-->
				...
				<div class="block">
					<!--// 리스트 -->
					<div class="list_zone">
						<div id="workTypeGrid" style="height: 30em; background-color: white;"></div>
					</div>
					<!-- 리스트// -->
				</div>
				<!--content//-->
