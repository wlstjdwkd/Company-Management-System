...
<script src="/gridDef/ev/EMPinfoGrid.js"></script>
...
function registerCallback() {
   EMPinfogridView.onCellClicked = function (grid, clickData) {
      if(clickData.cellType == "data"){
         ...
         var form = document.dataForm;
         form.df_method_nm.value = "programResume";
               ...
               <div class="block">
                  ...
                  <div class="btn_page_last">
						<a class="btn_page_admin" href="#"
							onclick="btn_program_regist_view()"><span>등록</span></a>
					</div>
                  <br> <br>
                  <!-- 리스트// -->
               </div>
