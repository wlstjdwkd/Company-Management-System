...
<script type="text/javascript">
	$(document).ready(function() {
		...
		$("#excelDown").click(function(){
        	...
        	jsFiledownload("/PGIM0030.do","df_method_nm=excelRsolver&ad_reqst_se=" + $("#ad_reqst_se").val() + "&ad_jdgmnt_reqst_year_from_search=" + $("#ad_jdgmnt_reqst_year_from_search").val() + "&ad_jdgmnt_reqst_year_to_search=" + $("#ad_jdgmnt_reqst_year_to_search").val());
        });
		...
		<div id="wrap">
			<div class="wrap_inn">
				<div class="contents">
						...
						<table cellpadding="0" cellspacing="0" class="table_search" summary="조회 조건">
							...
							<tbody>
								<tr>
									...
									<td>
										<ap:code id="reqst_se_search" grpCd="20" type="select" selectedCd="${inparam.REQST_SE}" ignoreCd="AK0" defaultLabel="전체" />
					...
					<div class="block">
						<h3>월별 신청기준 집계
                  			<div class="btn_pag fr"> <a class="btn_page_admin" href="#none" id="excelDown"><span>엑셀다운로드</span></a> </div>
                    		<p class="unit">(단위 : 개)</p>
						</h3>
						<!--// 리스트 -->
						<div class="list_zone">
