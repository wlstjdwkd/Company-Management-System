...
<div id="pop_sys_code">
	...
	<p class="specialTit">&lt;특례 대상 기업 확인&gt;</p>
	<ol class="specialCon">
		<c:choose>
			<c:when test="${confmSe eq 'B'}">
				<li>평균매출액 등이 3천억원 미만 : 해당 ☑,해당없음 ☐</li>
				<li>중소기업기본법 제2조제3항 본문에 따른 중소기업으로 보는 기간이 종료된 후 3년이 지나지 아니하였을 것 : 해당 ☑,해당없음 ☐</li>
			</c:when>
			<c:when test="${confmSe eq 'C'}">
				<li>평균매출액 등이 3천억원 미만 : 해당 ☑,해당없음 ☐</li>
				<li>중소기업기본법 제2조제3항 본문에 따른 중소기업으로 보는 기간이 종료된 후 3년이 지나지 아니하였을 것 : 해당 ☐,해당없음 ☑</li>
			</c:when>
			<c:when test="${confmSe eq 'D'}">
				<li>평균매출액 등이 3천억원 미만 : 해당 ☐,해당없음 ☑</li>
				<li>중소기업기본법 제2조제3항 본문에 따른 중소기업으로 보는 기간이 종료된 후 3년이 지나지 아니하였을 것 : 해당 ☑,해당없음 ☐</li>
			</c:when>
			<c:when test="${confmSe eq 'E'}">
				<li>평균매출액 등이 3천억원 미만 : 해당 ☐,해당없음 ☑</li>
				<li>중소기업기본법 제2조제3항 본문에 따른 중소기업으로 보는 기간이 종료된 후 3년이 지나지 아니하였을 것 : 해당 ☐,해당없음 ☑</li>
			</c:when>
		</c:choose>
