...
<!-- <div id="footer">
	...
	<div class="f_bottom">
		<div class="f_wrap">
			...
			<div class="addr">
				<p><span>운영 : </span>연합회</p>
				<p>TEL : 02-761-7710    FAX : 02-776-7702<br>COPYRIGHT © 연합회 ALL RIGHTS RESERVED.</p>
			</div>
