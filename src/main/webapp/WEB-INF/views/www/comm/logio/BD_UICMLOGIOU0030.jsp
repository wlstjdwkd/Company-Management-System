...
<script type="text/javascript">
	$(document).ready(function() {
		...
		// 확인
		$("#btn_find_userPwd").click(function() {
			$("#df_method_nm").val("findUserPwdForm");
			$("#dataForm").submit();
		});
	});
			...
			<div class="r_sec">
				...
				<div class="r_cont s_cont07_03">
					<div class="member_box">
						...
						<h3>회원의 아이디, 이름, 이메일을 확인해 주시면 임시 비밀번호를 발송해 드립니다.</h3>
						<p class="list_noraml"><span>아이디</span><input type="text" name="ad_user_id" id="ad_user_id" placeholder="아이디를 입력해 주세요. "></p>
					...
					<div class="btn_bl">
						<a href="#" id="btn_find_userPwd">확인</a>
					</div>
				</div>
			</div>
		</div>
