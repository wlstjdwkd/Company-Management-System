...
<body>
	<form name="dataForm" id="dataForm" action="<c:url value='${svcUrl}' />" method="post">
		...
		<input type="hidden" name="ad_user_nm" id="ad_user_nm" value="${userInfo.userNm}" /> <input
			type="hidden" name="ad_user_email" id="ad_user_email" value="${userInfo.email}" />
						...
						<div class="r_cont s_cont07_02">
							...
							<div class="member_box s_member_box">
								...
								<c:forEach items="${findUserId}" var="findUserId" varStatus="status">
									<h3>회원님의 아이디는 <span>${findUserId.loginId}</span> 입니다.</h3>
								</c:forEach>
							</div>
							<div class="btn_bl">
								<a href="#none" id="btn_find_userId_all" class="blu">전체 아이디 확인</a>
