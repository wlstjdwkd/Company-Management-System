															...
															try {
																if (response.result) {
																	...
																	jsMsgBox(
																			null,
																			'info',
																			'${userEmail} 이메일로 <br>회원님께 임시비밀번호를 발송하였습니다.');
																	return;
																} else {
																	return;
																}
															...
															try {
																if (response.result) {
																	...
																	jsMsgBox(
																			null,
																			'info',
																			'${mbtlNum.first}-${mbtlNum.middle}-${mbtlNum.last} 휴대전화번호로<br> 회원님께 임시비밀번호를 전송하였습니다.');
																	return;
																} else {
																	return;
																}
...
<body>
	<form name="dataForm" id="dataForm" action="<c:url value='${svcUrl}' />" method="post">
		...
		<input type="hidden" name="ad_user_id" id="ad_user_id" value="${userInfo.userId}" /> 
		<input type="hidden" name="ad_user_nm" id="ad_user_nm" value="${userInfo.userNm}" />
		<input type="hidden" name="ad_user_email" id="ad_user_email" value="${userInfo.userEmail}" />
		<!--//content-->
		<div id="wrap">
				...
				<div class="s_wrap">
					...
					<div class="r_sec">
						...
						<div class="r_cont s_cont07_03">
							<p class="resultGuide" style="width: 724px">아래 선택하신 수단으로 임시비밀번호를 전송해 드립니다.</p>
							<div class="member_box_wrap">
								<div class="member_box xs_member_box member_boxL">
									<h3 class="txt">아래의 이메일로<br/>임시비밀번호 받기</h3>
									<img src="/images2/sub/member/finde_password_mail_ico.png">
									<h4 class="fnt_bl">${userEmail}</h4>
								...
								<div class="member_box xs_member_box member_boxR">
									<h3 class="txt">아래의 휴대전화번호로<br/>임시비밀번호 받기</h3>
									<img src="/images2/sub/member/finde_password_ico.png">
									<h4 class="fnt_bl">${mbtlNum.first}-${mbtlNum.middle}-${mbtlNum.last}</h4>
									<div class="btn_center">
							...
							<div class="agree_st">
								<p class="list_noraml">임시비밀번호가 전송되면 사용하시던 비밀번호로는 더 이상 로그인하실 수 없습니다.</p>
								<p class="list_noraml">발급된 임시비밀번호는 마이페이지 - 회원정보조회에서 반드시 변경바랍니다.</p>
							</div>
							<div class="btn_bl">
				...
				<div class="modal_wrap">
					<div class="modal_header"> 
					 ...
					 <div class="modal_cont">
						<div class="img_quide">
							<img src="/images2/sub/info_ico.png" style="margin-top: -32px; margin-bottom: -10px;"><div class="img_guide_txt">
								<p>등록하신 이메일로<br/>회원님께 임시 비밀번호를 전송하였습니다. </p>
							</div>
						</div>
						<div class="btn_bl">
				...
				<div class="modal_wrap">
					<div class="modal_header"> 
					 ...
					 <div class="modal_cont">
						<div class="img_quide">
							<img src="/images2/sub/info_ico.png" style="margin-top: -32px; margin-bottom: -10px;"><div class="img_guide_txt">
								<p>등록하신 휴대전화번호로<br/>회원님께 임시 비밀번호를 전송하였습니다. </p>
							</div>
						</div>
						<div class="btn_bl">
